...
class MedicalConditionAdapter(context: Context, private val moviesList: List<RecyclerDto>) : RecyclerView.Adapter<MedicalConditionAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemLayout = LayoutInflater.from(mContext).inflate(R.layout.medical_condition_recycler_list, parent, false) as ConstraintLayout
