...
class TreatmentKitInvestigationAdapter(
    ...
    RecyclerView.Adapter<TreatmentKitInvestigationAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view =
            LayoutInflater.from(context).inflate(R.layout.row_investigation_treatment, parent, false)
