...
*/
        ...
        binding?.clearCardView?.setOnClickListener({
            ...
            binding?.displayorderedittext?.setFocusable(true);
            binding?.displayorderedittext?.setFocusableInTouchMode(true); // user touches widget on phone with touch screen
            binding?.displayorderedittext?.setClickable(true); //
        })
        ...
        if (args == null) {
            ...
            binding?.displayorderedittext?.setFocusable(false);
            binding?.displayorderedittext?.setFocusableInTouchMode(false); // user touches widget on phone with touch screen
            binding?.displayorderedittext?.setClickable(false); //
        ...
        labManageFavAdapter?.setOnDeleteClickListener(object : DiagnosisFavAdapter.OnDeleteClickListener{
...
//            callbackfavourite?.onFavID(deletefavouriteID!!)
    ...
    val emrposListDataFavtRetrofitCallback = object : RetrofitCallback<FavAddListResponse> {
        override fun onSuccessfulResponse(responseBody: Response<FavAddListResponse>?) {
            ...
            data.display_order = responseBody?.body()?.responseContents?.favourite_display_order?.toString()
