...
class ManageLabFavourteViewModel(
    ...
    fun getADDFavourite(facilityID: Int?, requestbody : RequestLabFavModel,
    ...
    fun getFavourites(
        ...
        apiService?.getFavourites(AppConstants.BEARER_AUTH + userDataStoreBean?.access_token, userDataStoreBean?.uuid!!, departmentID!!,
