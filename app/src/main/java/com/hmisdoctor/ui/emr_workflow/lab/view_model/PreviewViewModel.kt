...
import com.hmisdoctor.config.AppConstants.Companion.LAB_MASTER_TYPE_ID
...
class PreviewViewModel(
    application: Application,val  prevLabrecordsRetrofitCallback: RetrofitCallback<PrevLabResponseModel>) : AndroidViewModel(application) {
