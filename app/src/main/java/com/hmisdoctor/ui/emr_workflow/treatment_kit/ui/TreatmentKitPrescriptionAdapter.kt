...
import com.hmisdoctor.ui.emr_workflow.prescription.ui.PrescriptionDurationAdapter
import com.hmisdoctor.ui.emr_workflow.prescription.ui.PrescriptionSearchResultAdapter
...
class TreatmentKitPrescriptionAdapter(
...
) : RecyclerView.Adapter<TreatmentKitPrescriptionAdapter.MyViewHolder>() {
    private var routeNamesMap = mutableMapOf<Int, String>()
    private var frequencyMap = mutableMapOf<Int, String>()

    private var frequnecyDataList:List<PresDrugFrequencyResponseContent?>?=null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.row_treatment_kit_prescription, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.frequency_spinner.onItemSelectedListener =
            object : AdapterView.OnItemSelectedListener {
                ...
                override fun onItemSelected(
                    ...
                    Log.i("",""+itemValue)
                    selectedResponseContent = favouritesArrayList[position]!!
                    favouritesArrayList[position]!!.perdayquantityPrescription= frequnecyDataList?.get(pos)!!.perdayquantity
        ...
        holder.instruction_spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
         ...
         /*holder.autoCompleteTextView!!.onItemClickListener = object  : AdapterView.OnItemClickListener{
                override fun onItemClick(
                    ...
                    favouritesArrayList[position]!!.test_master_id = institutionList.filterValues { it == itemValue }.keys.toList()[0]
...
///N need ti add
    ...
    fun setFrequencyList(responseContents: List<PresDrugFrequencyResponseContent?>?) {
