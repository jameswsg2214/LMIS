...
application!!
    ...
    fun AddFavourite(facilityUuid: Int, emrFavRequestModel: ChiefCompliantAddRequestModel, addFavRetrofitCallBack: RetrofitCallback<LabFavManageResponseModel>) {
        ...
        apiService?.getDiagonosisFavAddAll(AppConstants.BEARER_AUTH +userDataStoreBean?.access_token, userDataStoreBean?.uuid!!, facilityUuid, emrFavRequestModel)?.enqueue(
