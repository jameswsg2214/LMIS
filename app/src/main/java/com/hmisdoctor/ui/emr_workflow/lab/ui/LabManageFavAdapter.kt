...
class LabManageFavAdapter(
   ...
   val arrayListLabFavList: ArrayList<ResponseContentsfav?>
    ...
    @SuppressLint("NewApi")
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LabManageFavAdapter.MyViewHolder {
        val view =
            LayoutInflater.from(context).inflate(R.layout.row_lab_fav_add, parent, false) as ConstraintLayout
